...
all_features_not_guards = set() # not include guards - features #define'd outside of their own conditional. This may include identifiers that are not in all_features because they're never in #ifs
